...
func TestAndroid(t *testing.T) {
	...
	workspace, err := ioutil.TempDir("", "platon-android-")
	if err != nil {
	...
	build.CopyFile(filepath.Join("libs", "platon.aar"), "platon.aar", os.ModePerm)
